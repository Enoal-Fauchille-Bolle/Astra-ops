...
| [criterifresque](k3s/criteri-fresque)          | Criteri'Fresque website                           | 🌐 Web            | `web`            | Helm            | `criterifresque.enoal.fr`                                  | 🔜 Planned  |
...
| [porttracker](docker/porttracker)              | Port tracking dashboard                           | 🐳 Infrastructure | —                | Docker Compose  | `porttracker.lan`                                          | ✅ Active   |
